<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="HTMLInquilinos.aspx.cs" Inherits="Cada_de_prensentacion.HTMLInquilinos" %>
...
<body>
    ...
    <form id="form1" runat="server">
        ...
        <h2>BUSCAR DATOS PARA VER UN INQUILINO</h2><br/><br/><br/>

        <input type="number" runat="server" placeholder="INGRESAR DNI DEL INQUILINO" id="midni" />
        <br />
        <br />
        <asp:Button ID="btnmidni" runat="server" Text="Button" OnClick="buscarinquilinos"/>
        <br/>
        <br />
