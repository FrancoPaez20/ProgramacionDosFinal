...
namespace CapaLogica
{
    public class Duenio : Persona
    {
        ...
        public Duenio (string nombre, string apellido, string direccion, string telefono, string mail, int dni, string banco, int numerocuenta, int Id) : base (nombre, apellido, direccion, telefono, mail, dni)
        {
            this.Banco = banco;
